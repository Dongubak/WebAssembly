...
var _subNums = Module['_subNums'] = makeInvalidEarlyAccess('_subNums');
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports['subNums'] != 'undefined', 'missing Wasm export: subNums');
  _subNums = Module['_subNums'] = createExportWrapper('subNums', 2);
